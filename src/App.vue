...
<template>
  <nav>
    <ul>
      ...
      <router-link to="/components/Contact.vue">Contact</router-link>
    </ul>
  </nav>
  ...
  <section class="header">
    ...
    <div class="button">
      <button class="button2" @click="handleClickAndToggleVisibility">
        Click Me
      </button>

      <p v-if="isVisible">This is a Vanilla page I edited using Vue!</p>
    </div>
  </section>
</template>
